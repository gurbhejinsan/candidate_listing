        ...
        render={({ field: { name, onChange } }) => {
          return (
            <ReactSelect<IOption>
              ...
              classNames={{
                container: () =>
                  "placeholder:text-white-dark text-xs  mb-1 w-full   rounded-md  px-2 py-0 border border-slate-200  ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:bg-slate-950 dark:ring-offset-slate-950 dark:placeholder:text-slate-400 dark:focus-visible:ring-slate-300",
                menu: () =>
                  "form-input left-0 bg-[#020617]  rounded-md  border border-slate-800 ",
                menuList: () =>
                  "flex-col gap-1 w-full max-h-64 overflow-y-auto  divide-y divide-slate-800 p",
                input: () =>
